...
avg_vds = [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45] # the vein density to normalize each sliding window 
sliding_window_lengths =  [32, 64, 96, 128] #
model_location = "weights/f11-256-weights.24-0.383.h5"
